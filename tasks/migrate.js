...
module.exports = async function (
  ...
  const erc20Contract = await ethers.getContractFactory("TacoswapV2ERC20")
  ...
  const utacoRoll = await ethers.getContract("UTacoRoll")
  ...
  const migrateTx = await utacoRoll
    .connect(dev)
    .migrateWithPermit(
      tokenA,
      tokenB,
